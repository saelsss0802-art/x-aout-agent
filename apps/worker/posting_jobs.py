...
from core import BudgetExceededError, BudgetLedger, Poster
from core.db import SessionLocal
from core.models import Agent, DailyPDCA, Post, PostType
    ...
    with SessionLocal() as session:
        ...
        for post in due_posts:
            ...
            try:
                ...
                external_id = posting_poster.post_text(post.agent_id, post.content)
